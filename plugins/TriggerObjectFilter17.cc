...
//
template<class T>
class TriggerObjectFilter17 : public edm::EDFilter {
   public:
      explicit TriggerObjectFilter17(const edm::ParameterSet&);
      ~TriggerObjectFilter17();
...
//
template<class T>
TriggerObjectFilter17<T>::TriggerObjectFilter17(const edm::ParameterSet& iConfig):
hltConfig_(),
histos1D_(), 
histos2D_()
{
...
template<class T>
TriggerObjectFilter17<T>::~TriggerObjectFilter17()
{
...
//template<class T>
//void TriggerObjectFilter17<T>::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
//{
...
//
template<class T>
void TriggerObjectFilter17<T>::beginRun(const edm::Run& iRun, edm::EventSetup const& iSetup)
{
  bool changed_ = true;
...
template<class T>
void
TriggerObjectFilter17<T>::beginJob()
{
...
template<class T>
bool
TriggerObjectFilter17<T>::filter( edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
template<class T>
void 
TriggerObjectFilter17<T>::endJob() {
...
template<class T>
void TriggerObjectFilter17<T>::endRun(const edm::Run& iRun, edm::EventSetup const& iSetup)
{
...
template<class T>
void
TriggerObjectFilter17<T>::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
typedef TriggerObjectFilter17<reco::Muon> MuonTriggerObjectFilter17;
DEFINE_FWK_MODULE(MuonTriggerObjectFilter17);
